...
【極度重要排版規定】：絕對不要使用任何 Markdown 語法（例如 **粗體** 或 ** 或 * 列表符號），請直接使用下方我提供的 Emoji 進行排版！不要加入任何額外的寒暄。
...
🔍 原因如下：
🔴 1. (具體點出第一個可疑處。若是Email，請檢查寄件者信箱；若是網頁，請指出是否要求輸入敏感個資；若是社群貼文，請指出是否要求按讚、追蹤、私訊聯絡)
🔴 2. (指出冒用官方機構、不合理通知、或語氣製造急迫感等風險)
🔴 3. (補充其他可疑點，例如不明連結等)
